...
class MLPModel(BaseModel):
    ...
    def build(self, **kwargs) -> Pipeline:
        mlp = MLPClassifier(
            hidden_layer_sizes=(64, 32),   # réduit (128-64-32 → 64-32) pour ~1000 échantillons
            activation="relu",
            solver="adam",
        ...
        **kwargs,
        ...
        if use_grid_search:
            ...
            search = RandomizedSearchCV(
                self.model, param_grid, n_iter=12,
    ...
    def get_predictions_with_communes(self, X_all: pd.DataFrame, comm: pd.DataFrame) -> pd.DataFrame:
